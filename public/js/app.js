...
var render = function() {
  ...
  return _c("section", { staticClass: "search-overlay" }, [
    ...
    _c("input", {
      ref: "input",
      staticClass: "input",
      attrs: { name: "", type: "text", placeholder: "Type Here..." }
    })
  ])
}
var staticRenderFns = [
